...
class LegalAdminTermsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['registration']['registration_modal_terms'] = [
      ...
      '#options'       => [0 => $this->t('New window'), 1 => $this->t('Modal overlay')],
      '#description'   => $this->t('How to display the T&Cs when a user clicks on the link.'),
      '#required'      => TRUE,
      '#states'        => [
        'visible' => [
          ':input[name="registration_terms_style"]' => ['value' => 3],
        ],
      ],
    ];
    ...
    $form['login']['login_modal_terms'] = [
      ...
      '#states'        => [
        'visible' => [
          ':input[name="login_terms_style"]' => ['value' => 3],
        ],
      ],
    ];
